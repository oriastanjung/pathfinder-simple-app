    ...
    while True:
        ...
        if searching == False :
            ...
            for x in range (len(road_path)) :
                courier_x = road_path[x][0] * window_width // columns
                courier_y = road_path[x][1] * window_height // columns
                grid[road_path[x-1][0]][road_path[x-1][1]].draw(window , (100,100,100))
                window.blit(courier, (courier_x,courier_y))
                print(courier_x, courier_y)
